...
(defpowerline percent     (propertize (emacs-uptime "%dd %hh")))
...
(setq-default mode-line-format
              (list "%e"
                    '(:eval (concat
                             ...
                             (powerline-buffer-id      'left   nil  "#586e75" )
                             (powerline-row            'left        "#586e75" )
                             (powerline-narrow         'left        "#586e75" "#839496" )
                             (powerline-vc             'center      "#839496" )
                             (powerline-make-fill                   "#839496" )
                             (powerline-narrow         'right       "#586e75" "#839496" )
                             (powerline-major-mode     'right        "#586e75" )
                             (powerline-minor-modes    'right        "#586e75" )
                             (powerline-percent        'right  nil  "#586e75" )
